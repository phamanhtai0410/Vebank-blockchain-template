...
A. Description:
====
This contract allows vesting tokens for private, public, airdrop,... Deploy smart contract for public sale, whitelisted users can deposit money into the contract to buy VB token.
